...
This [starter template](https://github.com/the-pudding/svelte-starter) aims to quickly scaffold a [SvelteKit](https://kit.svelte.dev/) project, designed around data-driven, visual stories at [Analyst+](https://pudding.cool).

### Notes
* _Do not use or reproduce Analyst+ logos or fonts without written permission._
